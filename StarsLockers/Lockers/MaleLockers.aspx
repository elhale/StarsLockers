<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MaleLockers.aspx.cs" Inherits="StarsLockers.Lockers.MaleLockers1" %>
<asp:Content ID="MaleLockerContent" ContentPlaceHolderID="MainContent" runat="server">
    
    <br />

    <div class="card bg-primary text-white">
      <div class="card-body">
          <h5 style="text-align:center;">Male Locker Assignments</h5>
      </div>     
    </div>

    <asp:GridView ID="MaleLockerGridView" runat="server" CssClass="table table-striped table-hover table-bordered table-sm" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="MaleLockerDS">
